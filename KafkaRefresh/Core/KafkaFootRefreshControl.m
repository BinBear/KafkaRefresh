...
- (void)layoutSubviews {
    ...
    self.kr_top = (self.scrollView.contentHeight <= self.scrollView.kr_height - self.scrollView.contentInset.top ? (self.scrollView.kr_height - self.scrollView.contentInset.top) : self.scrollView.contentHeight);
}
